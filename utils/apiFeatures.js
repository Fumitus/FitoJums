class APIFeatures {
  ...
  filter() {
    ...
    this.query = this.query.find(JSON.parse(queryStr)); //perkelus medota i klase, taip buvo pakeista apacioje esanti ielute
  ...
  limitFields() {
    if (this.queryString.fields) {
      ...
      this.query = this.query.select(fields); // vadinama projecting
    } else {
